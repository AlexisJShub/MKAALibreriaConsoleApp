...
-- Insertar usuarios de prueba iniciales con Hash SHA-256
CALL sp_registrar_usuario('manuel', SHA2('admin', 256), 'admin');
CALL sp_registrar_usuario('empleado1', SHA2('emp123', 256), 'empleado');
CALL sp_registrar_usuario('cajero1', SHA2('caj123', 256), 'cajero');
